        ...
        try {
            ...
            if (loginUser != null) {
                if (loginUser.getUserID() == userID) {
                    ...
                    if (checkDelete) {
                        checkDelete = daoAddress.delete(userID);
                        if (checkDelete) {
                            checkDelete = daoOrder.delete(userID);
                            if (checkDelete) {
                                ...
                                request.setAttribute("ERROR", "Can't delete user orders");
                            }
                        } else {
                            request.setAttribute("ERROR", "Can't delete user address!");
                        }
                    } else {
                        request.setAttribute("ERROR", "Can't delete user order details!");
                    }
                }
            }

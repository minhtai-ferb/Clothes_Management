    ...
    <body class="container-fluid">
        ...
        <main class="main" style="display: flex; justify-content: center; align-items: center ;height: 90vh;">
            ...
            <div style="text-align: center; width: 400px;">
                ...
                <p style="color: red; font-size: 15px; margin: 0; padding: 3px 0 3px 0;" id="error">${requestScope.ERROR}</p>
                <form action="MainController" method="POST" >
                    ...
                    <button style="margin-top: 15px; margin-bottom: 15px;" id="form" type="submit" name="action" value="Login" class="container-fluid checkout-button">
                        LOGIN
                    </button> 
                    
                    <div>
                        <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/ClothesManagement/LoginGoogleHandler&response_type=code
		   &client_id=562616454371-s6q18kfqhi5h41mnots4aeu7eh8h0eu7.apps.googleusercontent.com&approval_prompt=force">Login With Google</a>
                    </div>
                </form>
                <p style="margin: 0; padding: 20px 0 20px 0; font-size: 14px; font-weight: 450; color: #5a5959;">Don't have an account?<a style="color: black;" href="MainController?action=Create_Page">Create User</a></p>
            </div>
        </main>
    </body>

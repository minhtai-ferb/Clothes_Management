    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-white" id="sidebar-wrapper">
                <div class="logo text-center primary-text fs-4 fw-bold text-uppercase border-bottom">
                ...
                <div class="list-group list-group-flush my-3">
                    <a href="MainController?action=Dashboard" class="list-group-item list-group-item-action bg-transparent second-text active">
                        <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                    </a>
                    <a href="MainController?action=Account_Admin" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
